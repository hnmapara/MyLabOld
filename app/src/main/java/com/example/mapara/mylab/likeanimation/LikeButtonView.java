...
//        setOnClickListener(this);
    ...
    public void ivStarEnable(boolean value) {
        ivStar.setImageResource(value ? R.drawable.star_tint : R.drawable.star_nonselected);
    }

    public void onClick1(View v) {
        isChecked = !isChecked;
//        ivStar.setImageResource(isChecked ? R.drawable.ic_star_rate_on : R.drawable.ic_star_rate_off);
        ivStar.setImageResource(R.drawable.star_tint);
